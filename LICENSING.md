...
| `shared/references/tlc-baseline.md`   | CC-BY-4.0        | Adapted methodology with attribution in `NOTICE`.                          |
| `shared/references/tdd-baseline.md`   | Attribution only | Inspired by `mattpocock/skills`; no separate source license claim is made. |
