...
- **v0.4:** Upgrade & Lifecycle.
- **v0.5:** Workflow Quality and PR pack refinements.
- **v0.6:** Multi-worktree refinements.
- **v0.7:** Adapter and source model.
- **v1.0:** stable config, eval runner, and upgrade path.
