...
Use `.sdd-agentic-flow/context/domain-glossary.md` only when explicitly authorized. `init` does not create it automatically. Setup or specification work may propose or create it after explicit authorization.
