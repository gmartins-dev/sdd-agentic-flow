...
and `design.md` in this directory are what `sdd-create-specs` in **existing-code mode** would
...
path from `sdd-create-specs`'s existing-code mode, where `tasks.md` is only created if the
