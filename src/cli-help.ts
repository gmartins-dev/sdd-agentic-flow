...
export const USAGE = {
  ...
  install:
    'usage: install <pack> [--scope user|project] [--target agents|cursor|claude|copilot] [--plan] [--interactive] [--quiet]',
...
export const COMMAND_HELP: Record<string, string> = {
  ...
  uninstall: `sdd-agentic-flow uninstall\n\nRemove only recognized v5 managed assets.\n\nUSAGE\n  ${USAGE.uninstall}\n\nUse --plan first; --yes authorizes local Class-B apply outside a TTY.\n${shared}`,
