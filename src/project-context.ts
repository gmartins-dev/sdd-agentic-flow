...
\`npx sdd-agentic-flow context refresh\` after project changes. Run
\`npx sdd-agentic-flow context status\` to check what this file reflects without regenerating it.
